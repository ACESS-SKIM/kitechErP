  ...
  return (
    <>
      ...
      <div>
        ...
        >
          <Box sx={style2}>
            <PartAllow closeEvent={handlePartAllowClose} />
          </Box>
        </Modal>
      </div>
      <Box height={20} />
      <Grid container spacing={2}>
        ...
        <Grid item xs={3}>
          ...
          <TextField
            ...
            variant="outlined"
            size="small"
            onChange={handlePartSerialNameChange}
        ...
        <Grid item xs={3}>
          ...
          <button className="border-0 bg-white text-black pt-2">Part Allow Select</button>
          <PersonAddAlt1
            style={{
              fontSize: '20px',
              color: 'blue',
