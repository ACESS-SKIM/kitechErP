...
export default function ReusedTable2({ productID }) {
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell {...tableCellStyles1}>Part Code</TableCell>
        ...
        <TableBody>
          {data.map((row, index) => (
            <TableRow key={index} sx={{ '& .MuiTableCell-root': { borderBottom: '1px solid #111111' } }}>
              ...
              <TableCell {...tableCellStyles2}>{row.partCode}</TableCell>
