    ...
    <>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={3}>
          ...
          <TextField id="outlined-basic" label="Enter Part Name" variant="outlined" size='small' onChange={handlePartNameChange} value={partname} sx={{ minWidth: '100%', mb: 2 }} />
        </Grid>
        {/* 고유번호 */}
        <Grid item xs={3}>
          <Typography variant="subtitle1" mb={1}>
          ...
          <TextField id="outlined-basic" label="Enter Part Code" variant="outlined" size='small' onChange={handlePartSerialNameChange} value={partserialname} sx={{ minWidth: '100%', mb: 2 }} />
        </Grid>
        {/* 관리코드 */}
        <Grid item xs={3}>
          <Typography variant="subtitle1" mb={1}>
          ...
          <TextField id="outlined-basic" label="Enter Management Code" variant="outlined" size='small' onChange={handleManagementCodeChange} value={managementCode} sx={{ minWidth: '100%', mb: 2 }} />
        </Grid>
        {/* Part Weight 항목 */}
        <Grid item xs={3}>
          <Typography variant="subtitle1" mb={1}>
        ...
        <Grid item xs={3}>
          ...
          <TextField id="outlined-basic" label="Select EoL Scenario" select variant="outlined" size='small' onChange={handlePreprocessChange} value={preprocess} sx={{ minWidth: '100%', mb: 2 }}>
        ...
        <Grid item xs={6}>
          ...
          <TextField id="outlined-basic" label="Enter Memo" variant="outlined" size='small' onChange={handlePartMemoChange} value={partmemo} sx={{ minWidth: '100%', mb: 2 }} />
        </Grid>
