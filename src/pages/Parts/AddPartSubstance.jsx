...
export default function AddPartSubstance({ closeEvent, currentPartID, currentMaterialID }) {
  ...
  const createSubstance = async () => {
    try {
      const substancesCollectionRef = collection(db, 'parts', currentPartID, 'materials', currentMaterialID, 'substances');
