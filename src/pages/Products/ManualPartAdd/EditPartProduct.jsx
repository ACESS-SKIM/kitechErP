...
export default function EditPartProduct({ fid, closeEvent }) {
  ...
  const updatePart = async () => {
    const userDoc = doc(db, 'productparts', fid.id);
    const newFields = {
    ...
    <>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={3}>
          ...
          <TextField id="outlined-basic" label="Part Code" variant="outlined" size='small' onChange={handleInputChange} value={partData.partserialname} name='partserialname' sx={{ minWidth: '100%', mb: 2 }} />
        </Grid>
        {/* 관리코드 */}
        <Grid item xs={3}>
          <Typography variant="subtitle1" mb={1}>
          ...
          <TextField id="outlined-basic" label="Management Code" variant="outlined" size='small' onChange={handleManagementCodeChange} value={partData.managementCode} sx={{ minWidth: '100%', mb: 2 }} />
        </Grid>
        {/* Part Weight */}
        <Grid item xs={3}>
          <Typography variant="subtitle1" mb={1}>
