...
export default function ProductSubstanceList({ closeEvent, initialPartID, initialMaterialID }) {
  ...
  const getSubstances = () => {
    const substanceCollectionRef = collection(db, 'productparts', currentPartID, 'materials', currentMaterialID, 'substances');
  ...
  const deleteApi = async (id) => {
    const substanceDoc = doc(db, 'productparts', currentPartID, 'materials', currentMaterialID, 'substances', id);
    ...
    <>
      ...
      <div>
        <Modal open={open} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
          <Box sx={style}>
            <AddProductSubstance closeEvent={handleClose} currentPartID={currentPartID} currentMaterialID={currentMaterialID} />
          </Box>
        </Modal>
